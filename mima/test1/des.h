...
extern __declspec(dllexport) int des_setup(const unsigned char *key, int keylen, int num_rounds, des_key *skey);
extern  __declspec(dllexport) void des_ecb_encrypt(const unsigned char *pt, unsigned char *ct, des_key *key);
extern __declspec(dllexport)  void des_ecb_decrypt(const unsigned char *ct, unsigned char *pt, des_key *key);
extern __declspec(dllexport) int des_test(void);
extern __declspec(dllexport) int des_keysize(int *desired_keysize);
